...
const devPort = Number.parseInt(process.env.PORT ?? String(DEFAULT_DEV_PORT), 10);
  ...
  plugins.push(
    ...
    VitePWA({
      ...
      manifest: {
        ...
        description: "A modern resume builder.",
        id: "/?source=pwa",
...
const config = defineConfig({
  ...
  server: {
    host: true,
    port: Number.isNaN(devPort) ? DEFAULT_DEV_PORT : devPort,
    strictPort: true,
    allowedHosts: true,
    hmr: {
      host: "localhost",
