...
export const env = createEnv({
  ...
  server: {
    ...
    // Harbor SSO Bridge (Optional)
    HARBOR_APP_URL: z.url({ protocol: /https?/ }).optional(),
    HARBOR_SSO_SIGNING_KEY: z.string().min(1).optional(),
    HARBOR_SSO_VERIFY_URL: z.url({ protocol: /https?/ }).optional(),
    HARBOR_SSO_LINK_URL: z.url({ protocol: /https?/ }).optional(),
    HARBOR_SSO_VERIFY_SECRET: z.string().min(1).optional(),
    HARBOR_SSO_LINK_SECRET: z.string().min(1).optional(),
    HARBOR_SSO_PASSWORD_SECRET: z.string().min(1).optional(),
  },
});
