  ...
  providers: {
    list: publicProcedure
      .route({
        ...
        description:
          "Returns a list of all authentication providers enabled on this Harbor Resume instance, along with their display names. Possible providers include password-based credentials, Google, GitHub, and custom OAuth. No authentication required.",
