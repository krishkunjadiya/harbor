...
const userRouter = {
  getCount: publicProcedure
    .route({
      ...
      description:
        "Returns the total number of registered users on this Harbor Resume instance. The count is cached for up to 6 hours for performance. No authentication required.",
...
const resumeRouter = {
  getCount: publicProcedure
    .route({
      ...
      description:
        "Returns the total number of resumes created on this Harbor Resume instance. The count is cached for up to 6 hours for performance. No authentication required.",
...
const githubRouter = {
  getStarCount: publicProcedure
    .route({
      ...
      description:
        "Returns the number of GitHub stars for the Harbor Resume repository. The count is cached for up to 6 hours and falls back to a last-known value if the GitHub API is unavailable. No authentication required.",
      successDescription: "The number of GitHub stars for the Harbor Resume repository.",
    })
