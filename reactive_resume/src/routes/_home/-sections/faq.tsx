...
const getFaqItems = (): FAQItemData[] => [
  {
    question: t`Can I use Reactive Resume without a subscription?`,
    answer: t`Yes! Reactive Resume is available to use with no hidden costs, premium tiers, or subscription fees.`,
  },
  {
  ...
  },
  {
    ...
    answer: t`Reactive Resume is privacy-focused and designed to give you a clean experience without ads, tracking, or unnecessary limitations.`,
  },
  {
