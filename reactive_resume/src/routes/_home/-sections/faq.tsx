...
const getFaqItems = (): FAQItemData[] => [
  {
    question: t`Can I use Harbor Resume without a subscription?`,
    answer: t`Yes! Harbor Resume is available to use with no hidden costs, premium tiers, or subscription fees.`,
  },
  {
    question: t`How is my data protected?`,
    answer: t`Your data is stored securely and is never shared with third parties. You can also self-host Harbor Resume on your own servers for complete control over your data.`,
  },
  {
  ...
  {
    question: t`Is Harbor Resume available in multiple languages?`,
    answer: (
      <Trans>
        Yes, Harbor Resume is available in multiple languages. You can choose your preferred language in the settings
  ...
  {
    question: t`What makes Harbor Resume different from other resume builders?`,
    answer: t`Harbor Resume is privacy-focused and designed to give you a clean experience without ads, tracking, or unnecessary limitations.`,
  },
  {
