...
const getFeatures = (): Feature[] => [
  {
    ...
    icon: KeyIcon,
    title: t`Quick Setup`,
    description: t`Start building your resume in minutes with an intuitive workflow.`,
  },
  {
    id: "easy-sharing",
    icon: GlobeIcon,
    title: t`Easy Sharing`,
    description: t`Share your resume instantly with a public link when you are ready.`,
  },
  {
    id: "no-ads",
    icon: ProhibitIcon,
    ...
    <section id="features">
      ...
      >
        ...
        <p className="max-w-2xl leading-relaxed text-muted-foreground">
          <Trans>
            Everything you need to create, customize, and share professional resumes with confidence.
          </Trans>
        </p>
      </motion.div>
