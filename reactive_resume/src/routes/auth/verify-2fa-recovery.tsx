...
export const Route = createFileRoute("/auth/verify-2fa-recovery")({
...
function RouteComponent() {
  ...
  const onSubmit = async (data: FormValues) => {
    const toastId = toast.loading(t`Verifying recovery code...`);
    ...
    <>
      <div className="space-y-1 text-center">
        <h1 className="text-2xl font-bold tracking-tight">
          <Trans>Verify with a recovery code</Trans>
        </h1>
        <div className="text-muted-foreground">
          <Trans>Enter one of your saved recovery codes to access your account</Trans>
        </div>
      </div>
