...
import { Route as SsoLaunchRouteImport } from "./routes/sso/launch";
import { Route as PrinterResumeIdRouteImport } from "./routes/printer/$resumeId";
import { Route as AuthVerify2faRecoveryRouteImport } from "./routes/auth/verify-2fa-recovery";
...
const SsoLaunchRoute = SsoLaunchRouteImport.update({
  id: "/sso/launch",
  path: "/sso/launch",
  getParentRoute: () => rootRouteImport,
} as any);
...
const AuthVerify2faRecoveryRoute = AuthVerify2faRecoveryRouteImport.update({
  id: "/verify-2fa-recovery",
...
export interface FileRoutesByFullPath {
  ...
  "/auth/verify-2fa-recovery": typeof AuthVerify2faRecoveryRoute;
  "/printer/$resumeId": typeof PrinterResumeIdRoute;
  "/sso/launch": typeof SsoLaunchRoute;
...
export interface RootRouteChildren {
  ...
  SsoLaunchRoute: typeof SsoLaunchRoute;
...
declare module "@tanstack/react-router" {
  interface FileRoutesByPath {
    ...
    "/sso/launch": {
      ...
      path: "/sso/launch";
      fullPath: "/sso/launch";
      preLoaderRoute: typeof SsoLaunchRouteImport;
      parentRoute: typeof rootRouteImport;
    };
    "/printer/$resumeId": {
      id: "/printer/$resumeId";
    ...
    "/auth/verify-2fa-recovery": {
      id: "/auth/verify-2fa-recovery";
      path: "/verify-2fa-recovery";
      fullPath: "/auth/verify-2fa-recovery";
      preLoaderRoute: typeof AuthVerify2faRecoveryRouteImport;
      parentRoute: typeof AuthRouteRoute;
    };
    "/auth/verify-2fa": {
      id: "/auth/verify-2fa";
...
interface AuthRouteRouteChildren {
  ...
  AuthVerify2faRecoveryRoute: typeof AuthVerify2faRecoveryRoute;
...
const AuthRouteRouteChildren: AuthRouteRouteChildren = {
  ...
  AuthVerify2faRecoveryRoute: AuthVerify2faRecoveryRoute,
