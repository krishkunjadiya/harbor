...
description: "Learn how to configure an AI provider and API key for AI-assisted features in Harbor Resume"
---
...
<Step title="Navigate to Artificial Intelligence settings">
  ...
  <Step title="How your data is stored and sent">
    ...
    <Info>
      <strong>Your credentials and AI configuration are never saved on Harbor Resume servers.</strong> They only live in your device's browser storage.
    </Info>
