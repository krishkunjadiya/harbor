---
title: "Using the API"
description: "Learn how to create API keys and authenticate requests to the Harbor Resume API"
---

<Steps>
  <Step title="Sign in to the dashboard">
    Head over to [https://harbor.dev](https://harbor.dev) and sign in with your account credentials.
  </Step>
...
<Step title="Navigate to API Keys settings">
  ...
  <Step title="Open the API reference">
    ...
    <Tip>
      You can also open it directly here: [API Reference](https://docs.harbor.dev/api-reference).
    </Tip>
  ...
  <Step title="Authenticate requests with x-api-key">
    ...
    <Info>
      If you're self-hosting, replace <code>https://harbor.dev</code> with your instance URL. The API is served under <code>/api/openapi</code>.
    </Info>

    ```bash
    curl "https://harbor.dev/api/openapi/resumes" \
