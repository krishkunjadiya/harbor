...
description: "Learn how to use the Private Notes section in Harbor Resume to keep track of job applications, company details, and other personal reminders for each resume."
---
