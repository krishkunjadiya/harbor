...
<Info>
  If you're self-hosting, replace `https://harbor.dev` with your instance URL. The API is served under `/api/openapi`.
</Info>
...
```bash
curl -X PATCH "https://harbor.dev/api/openapi/resume/YOUR_RESUME_ID" \
