...
description: "Learn how to create your first resume in Harbor Resume, set a name and slug, and open it in the builder."
---

<Steps>
  <Step title="Log in to your account">
    Head over to [https://harbor.dev](https://harbor.dev) and log in with your account credentials.
...
<Step title="Click “Create a new resume”">
  ...
  <Step title="Review (or edit) the slug">
    ...
    <Warning>
      If you choose to publicly share your resume, it will be accessible at `https://harbor.dev/{username}/{slug}`.
    </Warning>
