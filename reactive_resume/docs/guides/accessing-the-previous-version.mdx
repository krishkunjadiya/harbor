...
description: "Learn how to access the previous version (v4) of Harbor Resume if you need to retrieve old resumes or prefer the classic experience."
---

## The previous version is still available

If you've been using Harbor Resume for a while, you may have resumes saved in the previous version of the application. The good news is that **version 4 (v4) is still fully accessible** and will remain online for the foreseeable future.

<Info>The previous version of Harbor Resume is available at [https://v4.harbor.dev](https://v4.harbor.dev).</Info>
...
<Steps>
  <Step title="Visit the v4 application">
    Go to [https://v4.harbor.dev](https://v4.harbor.dev) in your browser.
  </Step>
...
If you'd like to move your resumes to the latest version of Harbor Resume, you can export them from v4 and import them into the new version:

1. In v4, open the resume you want to migrate
2. Export it as a JSON file
3. In the new version at [https://harbor.dev](https://harbor.dev), create a new account or log in
4. Use the import feature to upload your JSON file (select the "Harbor Resume v4 (JSON)" option)
