...
description: "How Harbor Resume handles personal data, cookies, uploads, and printing."
---

## Overview

This Privacy Policy explains how **Harbor Resume** (the “Service”) collects, uses, stores, and shares information when you use it.

Harbor Resume is open-source and can be operated in different ways (for example, by the official hosted service, or by an organization/self-hosted deployment). The specific data controller for your use depends on who operates the instance you are using.
...
<Note>
  **Note for self-hosted deployments:** If you are using the official hosted service at <code>harbor.dev</code>, the
...
Harbor Resume is a resume builder that lets you:
