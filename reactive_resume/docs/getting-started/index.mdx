---
title: "Introduction"
description: "Welcome to the documentation for Harbor Resume, a free and open-source resume builder that simplifies the process of creating, updating, and sharing your resume."
---

<Frame>
  <img src="/images/getting-started/banner.webp" alt="Harbor Resume Banner" />
</Frame>

## What is Harbor Resume?

**Harbor Resume** is a free and open-source resume builder designed to simplify the process of creating, updating, and sharing your professional resume. Built with privacy as a core principle, it gives you complete control over your data while providing a powerful, modern experience.
...
<Frame>
  <img src="/images/getting-started/infographic.webp" alt="An infographic of the major features of Harbor Resume" />
</Frame>

<AccordionGroup>
	<Accordion title="Completely Free & Open Source" icon="code-branch">
		Harbor Resume is licensed under MIT. You can use it for free, modify it, and even host your own instance. The
    ...
    <Accordion title="Multi-language Support" icon="globe">
    	Harbor Resume supports multiple languages, making it accessible to users worldwide. Contribute translations to
    ...
    <Accordion title="Self-hosting Ready" icon="server">
    	Deploy your own instance of Harbor Resume using Docker. Keep complete control over your data and infrastructure.
    </Accordion>
...
Whether you want to use our hosted version or run your own instance, Harbor Resume has got you covered.
...
<CardGroup cols={2}>
  ...
  <Card title="Development Setup" icon="code" href="/contributing/development">
    Set up a local development environment to contribute or customize Harbor Resume.
  </Card>
</CardGroup>

## Tech Stack

Harbor Resume is built with modern web technologies:
...
<CardGroup cols={2}>
  ...
  <Card title="Sponsor" icon="heart" href="https://opencollective.com/reactive-resume">
    Support the development and long-term sustainability of Harbor Resume.
  </Card>
</CardGroup>
