---
title: "Quickstart"
description: "Get started with Harbor Resume in minutes — use our hosted version or deploy your own instance"
---

## Options

Harbor Resume offers flexibility in how you want to use it. Choose the option that best fits your needs:
...
The easiest way to use Harbor Resume is through our cloud version at [harbor.dev](https://harbor.dev). **This service is completely free and will always remain free.**

<Steps>
	<Step title="Create an Account">
		Visit [harbor.dev](https://harbor.dev) and sign up for free using your email, or sign in with your GitHub or Google
		account.
	</Step>
...
For users who prefer complete control over their data, you can deploy Harbor Resume on your own infrastructure using Docker.
...
<Steps>
    ...
    <Step title="Start the Services">
    	...
    	**SeaweedFS** — S3-compatible storage for file uploads - **Printer** — PDF and screenshot generation service
    	(browserless/chromium) - **Harbor Resume** — The main application
    </Step>

    <Step title="Access Your Instance">
    	Once all services are running, access your Harbor Resume instance at: ``` http://localhost:3000 ```
    </Step>
...
| `app`       | 3000 | The main Harbor Resume application                        |
...
| `APP_URL`          | Public URL of your Application | `https://harbor.dev`                     |
...
<Note>
  **Hybrid Setup Note**: The `PRINTER_APP_URL` variable is required when running Harbor Resume outside of Docker while
...
<CardGroup cols={2}>
  <Card title="Development Setup" icon="code" href="/contributing/development">
    Set up a development environment to contribute or customize Harbor Resume.
  </Card>
