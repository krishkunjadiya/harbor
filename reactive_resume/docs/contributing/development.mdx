...
description: "Set up a local development environment for Harbor Resume"
---
...
This guide walks you through setting up Harbor Resume for local development. Whether you're contributing to the project or customizing it for your needs, these steps will get you up and running.
...
<Steps>
  ...
  <Step title="Start the Development Server">
    ...
    Your local Harbor Resume instance will be available at [http://localhost:3000](http://localhost:3000).
  </Step>
</Steps>
...
Harbor Resume uses [Lingui](https://lingui.dev/) for internationalization.
...
// For JSX content
<Trans>Welcome to Harbor Resume</Trans>;
```
