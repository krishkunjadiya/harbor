...
description: "Understand the architecture and codebase structure of Harbor Resume"
---

This guide provides a comprehensive overview of Harbor Resume's architecture and codebase structure, helping you understand how different parts of the application work together.

---

## Tech Stack Overview

Harbor Resume is built with a modern, type-safe stack:
...
**Diagram:** This flow shows data and control flow between the main architectural layers of Harbor Resume.
...
Harbor Resume uses a hybrid approach:
